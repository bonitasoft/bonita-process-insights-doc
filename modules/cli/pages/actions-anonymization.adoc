...
For example, if you first replace a value with a hash and then replace it with another value, the second action will be applied to the hashed value, not the original value.
