...
This repository contains the sources of the https://documentation.bonitasoft.com/bpi[Bonita Process Insights documentation site]. It uses https://docs.asciidoctor.org/asciidoc/latest/[AsciiDoc] format for
